<template>
    ...
    <DashboardContent>
        ...
        <div space-y-2>
            ...
            <div flex="~ justify-between <xl:col" rounded-xl bg-fs-overlay-2 ring="1 fs-overlay-4">
                <UiTable
                    :loading="isLoading"
...
const VueApexCharts = computed(
    () => isMounted.value && defineAsyncComponent(() => import('vue3-apexcharts')),
);
