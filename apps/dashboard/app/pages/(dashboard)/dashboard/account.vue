            ...
            <UiExpander op0>
                ...
                <template #content>
                    <form space-y-4 @submit.prevent="handleDomainsEdit">
                        <p text-fs-muted-1>
                            Configure your domains. These domains will be used to output a random
                            domain during upload.
                        </p>
            ...
            <UiExpander op0>
                ...
                <template #content>
                    <form space-y-4 @submit.prevent="handleEmbedEdit">
                        <p text-fs-muted-1>Configure how your files are embedded when shared.</p>
